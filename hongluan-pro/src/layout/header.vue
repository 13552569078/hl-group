<template>
  <hl-header>
    ...
    <hl-group class="header-left" gap="var(--xs)">
      <hl-button
        type="link"
        class="text-regular font-bold hover:text-primary"
    ...
    <div class="header-right">
      ...
      <div class="userinfo">
        ...
        <hl-dropdown class="m-l-xs">
          ...
          <template #dropdown>
            <hl-dropdown-menu>
              <hl-dropdown-item @click="userinfo">个人信息</hl-dropdown-item>
              ...
              <hl-dropdown-item @click="signOut">安全退出</hl-dropdown-item>
            </hl-dropdown-menu>
          </template>
        </hl-dropdown>
      </div>
  ...
  <hl-dialog v-model="openThemes" body-class="p-xxl" width="calc(var(--xxl) * 24)">
    ...
    <hl-pagination block line class="m-y-lg" align="items-center" layout="prev, pager, next" :total="50" />
  </hl-dialog>
</template>
