<template>
  ...
  >
    <template #default>
      ...
      >
        <template #prefix>
          <span @mousedown.prevent="onMouseDownInput" @touchstart="onTouchStartInput">
            <slot name="icon">
              <hl-icon>
      ...
      >
        ...
        <span class="input-affixe prefix" @mousedown.prevent="onMouseDownInput" @touchstart="onTouchStartInput">
          <slot name="icon">
            <hl-icon>
              <system-clock v-if="triggerName === 'clock'" />
              <system-calendar v-if="triggerName === 'calendar'" />
