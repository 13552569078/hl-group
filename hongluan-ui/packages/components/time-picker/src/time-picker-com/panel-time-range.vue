<template>
  <div v-if="actualVisible" :class="[namespace, 'range-picker']">
    <div class="picker-body">
      <div class="picker-cell is-left">
        <div class="picker-header">{{ t('hl.datepicker.startTime') }}</div>
        <div
      ...
      <div class="picker-cell is-right">
        <div class="picker-header">{{ t('hl.datepicker.endTime') }}</div>
        <div
          class="picker-content"
          :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
        >
