...
import { useDeprecated, useLocale } from '@hongluan-ui/hooks'
import { debugWarn } from '@hongluan-ui/utils'
import { INPUT_EVENT, UPDATE_MODEL_EVENT } from '@hongluan-ui/constants'
...
export const useCalendar = (
  ...
  // https://github.com/hongluan-ui/hongluan-ui/issues/3155
  ...
  const calculateValidatedDateRange = (
    ...
    else if ((firstMonth + 2) % 12 === lastMonth) {
  ...
  //     scope: 'Calendar',
  //     version: '2.5.0',
  //     ref: 'https://hongluan-ui.org/en-US/component/calendar.html#slots',
  //     type: 'Slot',
  //   },
