...
import { throwError, getScrollContainer, getOffsetTopDistance } from '@hongluan-ui/utils'
...
const getScrollOptions = (el: HTMLElement, instance: ComponentPublicInstance): ScrollOptions => {
  return Object.entries(attributes).reduce((acm, [name, option]) => {
    ...
    const attrVal = el.getAttribute(`infinite-scroll-${name}`) as keyof ComponentPublicInstance
