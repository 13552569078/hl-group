...
import { useAttrs, useConsistentProp, useNamespace } from '@hongluan-ui/hooks'
import { generateId, isArray, throwError } from '@hongluan-ui/utils'
import {
  CHANGE_EVENT,
  INPUT_EVENT,
  UPDATE_MODEL_EVENT,
...
const listboxId = computed(() => {
  return `${namespace.value}-${generateId()}`
})
