...
import { isNumber, isString, getScrollBarWidth } from '@hongluan-ui/utils'
...
import type { CSSProperties, VNode, VNodeChild, Ref, UnwrapRef } from 'vue'
...
const createGrid = ({
  ...
  return defineComponent({
    ...
    setup(props, { emit, expose, slots }) {
      ...
      const { namespace } = useNamespace('vg-wrapper')
      const renderWindow = () => {
