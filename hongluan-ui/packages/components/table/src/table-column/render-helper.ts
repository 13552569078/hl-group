...
function useRender<T>(
  ...
  const setColumnRenders = (column: TableColumnCtx<T>) => {
    ...
    if (props.renderHeader) {
      debugWarn(
        'TableColumn', 'Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.',
      )
