...
import { usePopperContainer } from '@hongluan-ui/hooks'
import { genTooltipProvides } from '../test-helper/provides'
import HlTooltipContent from '../src/content.vue'
...
describe('<TooltipContent />', () => {
  ...
  const createComponent = (props = {}, provides = {}) => {
    const wrapper = mount(
      {
        ...
        template: `<hl-tooltip-content><slot /></hl-tooltip-content>`,
        setup() {
          usePopperContainer()
        },
      },
    ...
    return wrapper.findComponent(HlTooltipContent)
  }
